  ...
  LangString TEXT_HuginExtracting ${LANG_ITALIAN} "Estrazione di Hugin in corso..."
  LangString TEXT_HuginExtractDetails ${LANG_ITALIAN} "Installazione di Hugin ${HUGIN_VERSION} in corso %s..."
  
  LangString TEXT_HuginDocExtracting ${LANG_ITALIAN} "Estrazione della documentazione di Hugin in corso..."
  LangString TEXT_HuginDocExtractDetails ${LANG_ITALIAN} "Installazione della documentazione di Hugin ${HUGIN_VERSION} in corso %s..."
  
  LangString DESC_SecHugin ${LANG_ITALIAN} "File eseguibile di Hugin e altri file essenziali per l'unione delle immagini, la correzione degli obiettivi e la fusione..."
  
  LangString DESC_SecHuginDoc ${LANG_ITALIAN} "Installa la documentazione di Hugin"
  LangString TEXT_SecHuginDoc ${LANG_ITALIAN} "Documentazione"
  ...
  LangString DESC_SecShortcutPrograms ${LANG_ITALIAN} "Crea le scorciatoie di Hugin nel menu Start"
