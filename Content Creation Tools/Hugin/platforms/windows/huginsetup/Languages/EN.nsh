  ...
  LangString TEXT_HuginExtracting ${LANG_ENGLISH} "Extracting Hugin package..."
  LangString TEXT_HuginExtractDetails ${LANG_ENGLISH} "Installing Hugin ${HUGIN_VERSION} package %s..."
  
  LangString TEXT_HuginDocExtracting ${LANG_ENGLISH} "Extracting Hugin Documentation package..."
  LangString TEXT_HuginDocExtractDetails ${LANG_ENGLISH} "Installing Hugin ${HUGIN_VERSION} Documentation package %s..."
  
  LangString DESC_SecHugin ${LANG_ENGLISH} "Hugin binary and other core files for image stitching, lens correction and merging.."
  
  LangString DESC_SecHuginDoc ${LANG_ENGLISH} "Install Hugin Documentation"
  LangString TEXT_SecHuginDoc ${LANG_ENGLISH} "Documentation"
  
  LangString DESC_SecShortcuts ${LANG_ENGLISH} "Create program shortcuts"
  LangString TEXT_SecShortcuts ${LANG_ENGLISH} "Shortcuts"
  
  LangString DESC_SecShortcutPrograms ${LANG_ENGLISH} "Create Hugin shortcuts in Start-Menu Programs"
  LangString TEXT_SecShortcutPrograms ${LANG_ENGLISH} "Add to Start Menu"
  
  LangString DESC_SecShortcutDesktop ${LANG_ENGLISH} "Create Hugin shortcut on Desktop"
