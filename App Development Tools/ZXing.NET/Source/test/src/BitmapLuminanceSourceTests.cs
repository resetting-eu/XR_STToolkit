...
namespace ZXing.Test
{
    ...
    public class BitmapLuminanceSourceTests
    {
        ...
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format1bppIndexed, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format4bppIndexed, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format8bppIndexed, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format16bppRgb565, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format24bppRgb, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format32bppRgb, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format32bppArgb, "abc")]
        [TestCase("../../../Source/test/data/luminance/qr-code-abc-24bit.bmp", PixelFormat.Format16bppRgb555, "abc")]
